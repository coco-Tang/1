...
import videoTargetComponent from '@/components/table/videoTargetComponent.vue'
...
export default {
  ...
  data () {
    ...
    //   taskId: '',
      ...
      columnDefs: [
        ...
        // },
        {
          headerName: '台标', editable: false,  menuTabs: ['columnsMenuTab'],
          hide: false, valueFormatter: this.vidFormatter
        },
        { headerName: '语种', editable: false, field: 'languagename', menuTabs: ['columnsMenuTab'],valueFormatter: this.langFormatter },
        // {
        ...
        // },
        {
          headerName: '视频时间', editable: false, field: 'starttime', menuTabs: ['columnsMenuTab'],
          // valueFormatter: this.starttimeFormatter,
          valueFormatter: this.starttimeFormatter
        },
        {
          headerName: '视频时长', editable: false, menuTabs: ['columnsMenuTab'],
        ...
        },
        {
          ...
          editable: false, 
          // field: 'keywords',
          cellRendererFramework: 'videoTargetComponent',
          menuTabs: ['columnsMenuTab'],
          // width: 600
        },
        {
          headerName: '调看人', editable: false, menuTabs: ['columnsMenuTab'],
        ...
        // },
        {
          headerName: '视频上传时间', editable: false, field: 'importtime', menuTabs: ['columnsMenuTab'],
          hide: true
        },
        {
          headerName: '结果返回时间', editable: false, field: 'recvtime', menuTabs: ['columnsMenuTab'],
          hide: true, valueFormatter: this.starttimeFormatter
        },
        // {
        ...
        // },
        {
          headerName: '视频ID', editable: false, field: 'callid', menuTabs: ['columnsMenuTab'],
          hide: true
        },
        // {
  ...
  components: {
    ...
    videoTargetComponent:videoTargetComponent,
  ...
  methods:{
    ...
    ...mapActions(['PLAYER_DATA','HIS_SWITCH','RESULT_DATA','VIDEO_DATA']),
    ...mapGetters(['getResultData','getNextRecord','getBillStatus','getPlatform','getHistorySwitch','getAccount','getVideoData']),
    exportExcel() {
    ...
    vidFormatter(v) {
      console.log('vidFormatter')
      console.log(v)
      console.log(v.data.vidresult)
      console.log(v.data.vidresult.v.vidresults)
      let str = '',data  = v.data.vidresult.v.vidresults
      for(let k in data){
        str += data[k].objectid + '、'
      }
