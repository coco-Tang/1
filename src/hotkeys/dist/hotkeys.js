...
(function (global, factory) {
  ...
  function addEvents(object, event, method) {
    // if (object.addEventListener) {
    //   object.addEventListener(event, method, false);
    // } else if (object.attachEvent) {
    //   object.attachEvent('on' + event, function () {
    ...
    for(var k = 0; k < object.length; k++){
      ...
      object[k].addEventListener(event, method, false);
    }
  }
  ...
  var isBindElements = false; // 是否绑定节点
  ...
  function unbind(key, scope) {
    console.log('unbind')
    console.log(key)
    key === 'enter' ? isBindElements = false : ''
  ...
  function hotkeys(key, option, method) {
    ...
    if (Object.prototype.toString.call(option) === '[object Object]' || Object.prototype.toString.call(option) === '[object NodeList]') {
    ...
    // if (typeof element !== 'undefined' ) {
      ...
      if(element.length > 1 && !isBindElements && option.element !== 'undefined'){

        // console.log('option.element')
        // console.log(option.element)
        
        isBindElements = true;
        addEvents(option.element, 'keydown', function (e) {
          dispatch(e);
        });
        addEvents(option.element, 'keyup', function (e) {
          clearModifier(e);
        });
      }else if(!isBindElement){
