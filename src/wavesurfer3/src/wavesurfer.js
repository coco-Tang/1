...
export default class WaveSurfer extends util.Observer {
    ...
    createDrawer() {
        ...
        this.drawer.on('redraw', () => {
            // console.log('redraw drawBuffer')
            this.drawBuffer();
            this.drawer.progress(this.backend.getPlayedPercents());
            // console.log('redraw drawBuffer1')
        });
        ...
        this.drawer.on('click', (e, progress) => {
            setTimeout(() => {
                ...
                this.dashedTime = this.getCurrentTime()
            }, 0);
     ...
     */
    getDuration() {
        // console.info('getDuration:', this.backend.getDuration())
    ...
    drawBuffer() {
        ...
        // console.log('nominalWidth')
        // console.log(nominalWidth)
        // console.log('minPxPerSec')
        // console.log(this.params.minPxPerSec)
        // console.log('pixelRatio')
        // console.log(this.params.pixelRatio)
        const parentWidth = this.drawer.getWidth() || 760;
        ...
        if (this.params.partialRender) {
            ...
            // console.log('1087 else')
            peaks = this.backend.getPeaks(width, start, end);
            this.drawer.drawPeaks(peaks, width, start, end);
        }
        // console.log('drawBuffer11111')
    ...
    zoom(pxPerSec) {
        ...
        let parentWidth = this.drawer.getWidth(),
            diff = Math.floor(parentWidth / (this.getDuration() * this.params.pixelRatio)) - 1;
            // console.log('diff: ',diff)
        if (diff > 0) { // big file doesn't need to add diff
            this.params.minPxPerSec += diff
        }else{
            // this.params.minPxPerSec = pxPerSec
            
        }
        // console.log('%c原始缩放值pxPerSec:', 'color:red', pxPerSec)
        // console.log('%c处理过的this.params.minPxPerSec:', 'color:green', this.params.minPxPerSec)
        // console.log('zoom drawBuffer')
        this.drawBuffer();
        this.drawer.progress(this.backend.getPlayedPercents());
    ...
    loadDecodedBuffer(buffer) {
        // console.log('loadDecodedBuffer')
        // console.log(buffer)
        this.backend.load(buffer);

        // console.log('copyFromChannel')
        // var anotherArray = new Float32Array;
        // buffer.copyToChannel(anotherArray,0,0)
        // console.log('anotherArray')
        // console.log(anotherArray)

        // console.log(this)
        //双声道
        buffer.numberOfChannels === 1 ? this.params.height = 120 : this.params.height = 100
        // console.log('loadDecodedBuffer drawBuffer')
        //大文件波纹模糊 
        // this.drawBuffer();
        this.fireEvent('ready');
        this.isReady = true;
        // console.log("%c buffer","color: red")
        // console.log(buffer)
    }
    ...
    loadBuffer(url, peaks, duration) {
        ...
        if (peaks) {
            ...
            // console.log('loadBuffer drawBuffer')
            this.drawBuffer();
