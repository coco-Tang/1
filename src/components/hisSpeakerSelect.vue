<template>
  <div class="hisSpeakerSelect mspeakerSelect speakerSelect">
    <el-dialog
      title="声纹"
      ...
      <div class="head">
        ...
        <div class="right">
         <!--  <ul>
            <li>
              <el-checkbox :disabled="invalidFlag" v-model="hitSpeaker" label="任意中标声纹"></el-checkbox>
            </li>
            <li>
              <span>阈值:</span>
...
<style lang="scss">
.mspeakerSelect.hisSpeakerSelect{
  .el-radio-group{
      flex-shrink: 0;
  }
