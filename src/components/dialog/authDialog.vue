 ...
 * @LastEditTime: 2019-10-28 18:58:37
 * @Description: 
 -->
<template>
  <div class="authDialog">
    ...
    <el-dialog
      ...
      :title="updateAuth.isEdit ? '编辑权限': '新建角色'"
      :visible.sync="dialogVisible"
      :close-on-click-modal="false"
      width="620px"
    >
      <el-form :model="form" label-position="left">
        <el-form-item class="roles" label="角色">
          <el-input v-model="form.role" :disabled="updateAuth.isEdit" placeholder="请输入需要创建的职位"></el-input>
        </el-form-item>
  ...
  methods: {
    ...
    uploadFile() {
      ...
      if (isEdit) {
        ...
        if (this.form.auth.length===0) return this.$message.error("权限不能为空");
