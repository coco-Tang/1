...
<template>
  <div class="cellOperation" ref="childComponent">
    <el-button class="task-info-edit" @click="edit" :disabled="isOnline">编辑</el-button>
    <el-button class="task-info-edit" @click="showSlidePanel">文件</el-button>
  </div>
</template>
...
export default Vue.extend({
  ...
  methods: {
    ...
    showSlidePanel() {
      this.parent.$refs.compSlide.$emit("showSlidePanel", this.params);
    }
  },
  beforeCreate() {},
  created() {},
