  ...
  export default Vue.extend({
    ...
    methods: {
      ...
      dataInit() {
        ...
        if(data.kwdhits){
          if(data.kwdhits.combiner){
            this.keywordsarr = this.arrHashFilter(data.kwdhits.combiner,'keyword')
        ...
        if(data.speakerhits){
          if(data.speakerhits.combiner){
            this.speakersarr = this.arrHashFilter(data.speakerhits.combiner,'speakername')
